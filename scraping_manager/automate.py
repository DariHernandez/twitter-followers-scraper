...
class Web_scraping (): 
    ...
    def save_page(self, file_html): 
        ...
        page_file = open(os.path.join (current_folder, file_html), "w", encoding='utf8')
